...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='datasets/train/EnlightenGAN', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--use_norm', type=float, default=1, help='use norm')
        ...
        self.parser.add_argument('--input_linear', action='store_true', help='linear scaling input')
        self.parser.add_argument('--linear_add', action='store_true', help='linear scaling input')
        self.parser.add_argument('--latent_threshold', action='store_true', help='linear scaling input')
        self.parser.add_argument('--latent_norm', action='store_true', help='linear scaling input')
